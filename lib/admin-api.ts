...
export const adminApi = {
  ...
  updateOrder: (id: string, body: { stage?: number; paid?: boolean; paidCash?: number; paidTransfer?: number; balancePaid?: boolean; paidVerified?: boolean; balancePaidVerified?: boolean }) => req<{ order: Order }>(`/api/admin/orders/${id}`, 'PATCH', body),
