...
const SEED: StoreData = {
  ...
  orders: [
    { id: 'DC-26-48213', customer: 'Amina Shareef',    email: 'amina@email.mv',   items: 'Amara Wrap Midi ×1, Silk Scarf ×1', subtotal: 760, discount: 0, productDiscount: 0, deliveryFee: 75, total: 835,  method: 'Delivery' as const, stage: 2 as const, readyForDeliveryAt: null, date: '12 Jun 2026', paid: true,  paidCash: 835, paidCard: 0, paidTransfer: 0, depositRequired: 835, balanceDue: 0, balancePaid: false, source: 'web' as const, origin: 'web_checkout' as const, locationId: null, locationName: null },
    { id: 'DC-26-47980', customer: 'Aishath Rasheed',  email: 'aishath@email.mv', items: 'Horizon Maxi Dress ×1',              subtotal: 780, discount: 0, productDiscount: 0, deliveryFee: 75, total: 855,  method: 'Delivery' as const, stage: 3 as const, readyForDeliveryAt: '2026-06-11T00:00:00.000Z', date: '11 Jun 2026', paid: true,  paidCash: 855, paidCard: 0, paidTransfer: 0, depositRequired: 855, balanceDue: 0, balancePaid: false, source: 'web' as const, origin: 'web_checkout' as const, locationId: null, locationName: null },
    { id: 'DC-26-47655', customer: 'Fathimath Nazly',  email: 'fathimath@email.mv', items: 'Everyday Linen Dress ×2',          subtotal: 840, discount: 0, productDiscount: 0, deliveryFee: 75, total: 915,  method: 'Delivery' as const, stage: 1 as const, readyForDeliveryAt: null, date: '10 Jun 2026', paid: false, paidCash: 0,   paidCard: 0, paidTransfer: 0, depositRequired: 915, balanceDue: 0, balancePaid: false, source: 'web' as const, origin: 'web_checkout' as const, locationId: null, locationName: null },
    { id: 'DC-26-47502', customer: 'Mariyam Zoona',    email: 'mariyam@email.mv', items: 'Champagne Cocktail Dress ×1, Layered Chain Necklace ×1', subtotal: 1170, discount: 0, productDiscount: 0, deliveryFee: 75, total: 1245, method: 'Delivery' as const, stage: 0 as const, readyForDeliveryAt: null, date: '09 Jun 2026', paid: false, paidCash: 0, paidCard: 0, paidTransfer: 0, depositRequired: 1245, balanceDue: 0, balancePaid: false, source: 'web' as const, origin: 'web_checkout' as const, locationId: null, locationName: null },
  ],
  locations: [
