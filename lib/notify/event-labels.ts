...
export const ORDER_NOTIFICATION_EVENTS = ['orderPlaced', 'orderPaymentConfirmed', 'orderBalanceConfirmed', 'orderStatusUpdated', 'reviewRequested'] as const;

export const NOTIFICATION_EVENT_LABELS: Record<string, string> = {
  orderPlaced: 'Order placed',
  orderPaymentConfirmed: 'Payment confirmed',
  orderBalanceConfirmed: 'Balance payment confirmed',
