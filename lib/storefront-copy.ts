...
export const STOREFRONT_COPY_DEFAULTS: StorefrontCopy = {
  homepageNavigation: {
    ...
    categoryCustomDesc: 'Dresses for every celebration.',
  ...
  productCatalog: {
    ...
    customizableCasualHelp: 'Buy as-is, or get in touch for a bespoke size or fabric request.',
    customizableJerseyHelp: "Have a special request? Contact us and we'll see what we can do — no payment now.",
    customizationProfileHelp: 'customization is available. Complete the scoped options below and request a quote.',
    ...
    sizeGuideBuilderCta: 'Contact us',
    customizationUploadHelp: "After submitting you'll fill in your contact details. We'll review your request and get back to you within 48 hours — no payment now.",
  },
  cartQuoteStatus: {
    cartTitle: 'Your cart',
    cartEmptyHeadline: 'Nothing here yet.',
    cartMixedHeadline: 'You have buy-now items and custom items — handle each below.',
    cartFixedHeadline: 'Ready to check out with manual payment.',
    cartQuoteHeadline: 'Custom configurations ready to quote.',
    ...
    quoteSummaryTitle: 'Custom request',
    quoteSummaryBody: "We'll review your request and get back to you — no payment now.",
    quoteRequestCta: 'Send request',
    upsellTitle: 'Complete your look',
    upsellBody: 'Choose accessory options before you check out.',
    upsellSkip: 'Skip, go to checkout',
    quotePageTitle: 'Request sent',
    quotePageIntro: "Review your request and send it over. We'll get back to you directly.",
    quoteEmptyTitle: 'No custom items to send',
    quoteEmptyBody: 'Browse the collection to find a style you love.',
    quoteSuccessTitle: 'Request sent',
    quoteSuccessBody: 'Our team will review your request and email or SMS you back — usually within 48 hours. No payment now.',
...
export const STOREFRONT_COPY_LIMITS: { [S in CopySection]: Record<CopyKey<S>, number> } = {
  homepageNavigation: {
    navCustomLabel: 32, navAboutLabel: 24, statusLabel: 36, supportSizeGuideLabel: 28, supportShippingLabel: 32, supportFaqLabel: 18,
    ...
    categoryReadyDesc: 80, categoryCustomDesc: 80, categoryCasualDesc: 80, categoryAccessoriesDesc: 80, categoryExploreLabel: 24,
  ...
  productCatalog: {
    ...
    productStockLine: 48, quoteOnRequestLabel: 32,
    customizableCasualHelp: 160, customizableJerseyHelp: 160, customizationProfileHelp: 140,
    ...
    sizeGuideMeasureTitle: 40, sizeGuideMeasureBody: 200, sizeGuideTeamTitle: 40, sizeGuideTeamBody: 180, sizeGuideBuilderCta: 32,
    customizationUploadHelp: 180,
  },
  cartQuoteStatus: {
    cartTitle: 36, cartEmptyHeadline: 64, cartMixedHeadline: 120, cartFixedHeadline: 90, cartQuoteHeadline: 90,
    cartEmptyTitle: 48, cartEmptyBody: 140, shopReadyCta: 32, buildKitCta: 36, checkoutCta: 36, noCardCartNote: 80,
    quoteSummaryTitle: 40, quoteSummaryBody: 160, quoteRequestCta: 32,
    upsellTitle: 48, upsellBody: 120, upsellSkip: 36,
    quotePageTitle: 48, quotePageIntro: 160, quoteEmptyTitle: 56, quoteEmptyBody: 120,
    quoteSuccessTitle: 48, quoteSuccessBody: 180,
...
export const STOREFRONT_COPY_GROUPS: {
  ...
  title: ({
    ...
    cartQuoteStatus: 'Cart, Quote & Status',
  })[section],
  description: ({
    ...
    cartQuoteStatus: 'Cart empty states, quote helpers, upsell modal and status page headings.',
  })[section],
