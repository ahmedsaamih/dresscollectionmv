...
export const STOREFRONT_COPY_DEFAULTS: StorefrontCopy = {
  ...
  paymentCheckout: {
    ...
    orderPlacedBody: "We've received your order.",
    ...
    depositConfirmationBody: "We've received your 50% deposit. We'll be in touch when the balance is due.",
  },
  shippingPickup: {
    ...
    manualPaymentBody: "Because we don't take card payments, orders are dispatched once your bank transfer is received. Use your order reference as the transfer note.",
  },
  productCatalog: {
  ...
  cartQuoteStatus: {
    ...
    statusIntro: 'Enter the reference from your order confirmation.',
